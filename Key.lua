...
local Config = {
    ...
    ServiceId       = 29488, -- Your PlatoBoost Service ID
    PlatoSecret     = "92a467db-9093-4372-855c-cab74c633596", -- Your PlatoBoost Secret Key

    -- [2] Anti-Bypass / Global Secret Variable
    Secret          = "31530602N1", -- This makes the script ONLY run from the key script. Even if they copy the original obfuscated script to bypass the key, they won't be able to!
    
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/sosanelemino-hash/OPSYX-Key-System/refs/heads/main/script.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "OPSYX", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "OPSYX", -- Name of the main script's GUI to check if it's already executing
